...
for cls in myList:
    ...
    classNames.append(os.path.splitext(cls)[0])  # Get the name without extension
print(classNames)
...
while True:
    ...
    for encodeFace, faceLoc in zip(encodesCurFrame, facesCurFrame):
        ...
        if matches[matchIndex]:
            ...
            cv2.rectangle(img, (x1, y2 - 35), (x2, y2), (0, 255, 0), cv2.FILLED)  # Draw rectangle for name
